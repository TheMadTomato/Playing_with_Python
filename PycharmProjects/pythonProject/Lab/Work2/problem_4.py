...
Write a Python script that generates a random integer from 1 to 100, then asks the player to guess that
number. Game rules:
...
o If the guess is within 10 of the number, print "CLOSE!"
o If the guess is further away than that, print "FAR!"
4.5.6.If the player guessed a number that is closer to the generated number than the previous guess,
print "CLOSER"
If the player guessed a number that is farther from the generated number than the previous
guess, print "FARTHER"
At the end of the game, print out the number of guesses
"""
